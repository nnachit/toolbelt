<script lang="ts">
  ...
  function process() {
    ...
    try {
      ...
      error = mode === 'decode' ? 'Invalid URL-encoded string' : 'Encoding error';
      output = '';
    }
  }
...
<div class="max-w-4xl mx-auto">
  <h1 class="text-3xl font-bold mb-2">URL Encoder/Decoder</h1>
  <p class="text-gray-400 mb-8">Encode or decode URL components and full URLs.</p>
